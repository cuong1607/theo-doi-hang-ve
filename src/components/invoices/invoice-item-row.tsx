...
import type { SupplierProduct } from "@/lib/products/actions";

import type { InvoiceItemState } from "./invoice-form";
...
export function InvoiceItemRow({
  ...
  onChange: (patch: Partial<InvoiceItemState>) => void;
  onRemove: () => void;
}) {
